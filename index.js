...
function checkDataType(value) {
  ...
  if (typeof value === "undefined") {
    return `Значення ${value} має тип "undefined"`;
  } else if (typeof value === "number") {
    return `Значення ${value} має тип "number"`;
  } else if (typeof value === "boolean") {
    return `Значення ${value} має тип "boolean"`;
  } else if (typeof value === "string") {
    return `Значення ${value} має тип "string"`;
  }
}
...
function getVariableType(variable) {
  ...
  // Не дуже зрозуміло як використати тернарний оператор???? Оскільки значень більше ніж 2!!!
  //   typeof variable === "number"
  //     ? `${variable} "Це число"`
  //     : `${variable} "Це інший тип"`;
  //   typeof variable === "string"
  //     ? `${variable} "Це рядок"`
  //     : `${variable} "Це інший тип"`;
  //   typeof variable === "boolean"
  //     ? `${variable} "Це булеве значення"`
  //     : `${variable} "Це інший тип"`;
  //   return ???;
}
